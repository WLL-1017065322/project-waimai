    ...
    <section class="loginContainer">
        <div class="loginInner">
            ...
            <div class="login_content">
                    ...
                    <div :class="{on: !isPhone}">
                        <section>
                            ...
                            <section class="login_message">
                                ...
                                <img class="get_verification" :src="captchaSrc" alt="captcha" @click="getCaptcha" ref="captcha">
                            </section>
                        </section>
                    </div>
                ...
                <router-link class="toRegitser" to="/register">未注册?</router-link>
            </div>
...
export default {
  data() {
    return {
      ...
      alertText: '', // 提示框信息
      captchaSrc: 'http://api.wanglvlong.top/waimai/captcha/'
  ...
  methods: {
    ...
    getCaptcha() {
      // 每次指定的src要不一样
      this.$refs.captcha.src = `${this.captchaSrc}?time=${Date.now()}`;
    },
